...
<pre>
🤖 Claude Code    основной инструмент, почти всё делается через него
💬 Telegram-боты  пишут посты в моём стиле, собирают опросы, режут голосовые
💻 свой VPS       там живут боты и сайты, отвечаю за них сам
🧠 Gemini         расшифровка голосовых, разбор картинок
</pre>
